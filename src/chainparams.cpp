...
#       else
        vSeeds.push_back(CDNSSeedData("sd1", "45.32.245.217")); // SIN - AU
        vSeeds.push_back(CDNSSeedData("sd2", "45.76.118.90")); // US - AU
        vSeeds.push_back(CDNSSeedData("sd3", "45.77.44.147"));
        vSeeds.push_back(CDNSSeedData("sd4", "207.246.96.37"));
#       endif
